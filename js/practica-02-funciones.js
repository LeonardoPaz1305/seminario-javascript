...
const misDatos = (nombre, apellido, fechaNacimiento) => {
    return `Hola mi nombre es ${nombre} ${apellido} y nací el ${fechaNacimiento}`;
}
const RESULT_MIS_DATOS = misDatos('Leonardo', 'Paz Vargas', '13 de mayo de 1994');
console.log(RESULT_MIS_DATOS);
